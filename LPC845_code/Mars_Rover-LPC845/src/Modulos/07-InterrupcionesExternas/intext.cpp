 ...
 **********************************************************************************************************************************/
static Intext* intexts[MAX_INTEXTS];
...
{
	if( (m_pint >= MAX_INTEXTS) || (m_port > 1) || (m_pin > 31) )
		return -1;
	setup();
 ...
 * PININTx_IRQHandler
 ***************************************************************
 * Handlers de interrupciones externas.
 * Se ejecutan al detectar las condiciones de interrupción.
 */
...
//void PININT6_IRQHandler(void){ intexts[6]->limpiar_irq();}		// No se toma porque se puede utilizar para otras funcionalidades...
//void PININT7_IRQHandler(void){ intexts[7]->limpiar_irq();}		// No se toma porque se puede utilizar para otras funcionalidades...
